...
type OrdersService interface {
	TakeOrderFromCourier(ctx context.Context, order OrderInput) error
	...
	GetRefundList(ctx context.Context, pvzID, pageNum, pageSize int) ([]Order, error)
	GetCustomerOrderList(ctx context.Context, pvzID, customerID, limit int, isInStock bool) ([]Order, error)
}
